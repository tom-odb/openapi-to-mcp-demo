      ...
      <div class="instructions">
        ...
        <ol>
          ...
          <li>Install dependencies:
            <ul>
              <li>With uv (recommended): <code>uv sync</code> or <code>uv sync --extra composite</code></li>
              <li>With pip: <code>pip install -e .</code> or <code>pip install -e ".[composite]"</code></li>
            </ul>
          </li>
          <li>Copy <code>.env.example</code> to <code>.env</code> and configure your API key</li>
          <li>Set <code>ANTHROPIC_API_KEY</code> in <code>.env</code> if using composite tools</li>
          <li>Add the server to your MCP client:
            <ul>
              <li><strong>Claude Desktop:</strong> Update <code>claude_desktop_config.json</code></li>
              <li><strong>VS Code:</strong> Update <code>.vscode/mcp.json</code> in your workspace</li>
            </ul>
          </li>
          <li>See the generated <code>README.md</code> for detailed configuration examples</li>
        </ol>
      </div>
    </div>
  </div>
